...
protected:
	...
	CList<CMFCPropertyGridProperty*, CMFCPropertyGridProperty*> m_lstSubItems; // Sub-properties list
};
...
protected:
	...
	BOOL    m_bOpenFileDialog; // TRUE - use "File Open/Save" dialog; otherwise - folder selection dialog
