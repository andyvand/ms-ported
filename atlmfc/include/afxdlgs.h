...
#pragma warning(suppress:26433)
	STDMETHOD(QueryInterface)(REFIID riid, void** ppvObject) ATL_IUNKNOWN_NOEXCEPT;
	__declspec(nothrow) ULONG STDMETHODCALLTYPE AddRef() ATL_IUNKNOWN_NOEXCEPT override;
	__declspec(nothrow) ULONG STDMETHODCALLTYPE Release() ATL_IUNKNOWN_NOEXCEPT override;
