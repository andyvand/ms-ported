...
/////////////////////////////////////////////////////////////////////////////
// CDataPathProperty - Asynchronous properties for OLE Controls
...
public:
	...
	BOOL Open(LPCTSTR lpszPath, CFileException* pError = NULL) override;
...
/////////////////////////////////////////////////////////////////////////////
// CCachedDataPathProperty - Cached asynchronous properties for OLE Controls
...
// Implementation
public:
	void OnDataAvailable(DWORD dwSize, DWORD bscfFlag) override;
	void Close() override;
...
protected:
	...
	// Type library
	BOOL GetDispatchIID(IID* pIID) override;

	// Connection point container
	LPCONNECTIONPOINT GetConnectionHook(REFIID iid) override;
	BOOL GetExtraConnectionPoints(CPtrArray* pConnPoints) override;
	...
	static const AFX_EVENTMAP* PASCAL GetThisEventMap();
#endif
	_Ret_notnull_ virtual const AFX_EVENTMAP* GetEventMap() const;
	static const AFX_EVENTMAP eventMap;
	...
	BOOL OnCreateAggregates() override;
	...
	// Automation
	BOOL IsInvokeAllowed(DISPID dispid) override;
...
protected:
	...
	BEGIN_CONNECTION_PART(COleControl, EventConnPt)
		void OnAdvise(BOOL bAdvise) override;
		REFIID GetIID() override;
		HRESULT QuerySinkInterface(LPUNKNOWN pUnkSink,
...
protected:
	...
	BOOL PreTranslateMessage(LPMSG lpMsg) override;
	void OnFinalRelease() override;
