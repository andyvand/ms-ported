...
public:
	...
	virtual void ResetImages();	// Reset all toolbar images except user-defined to the default
	...
	int ReplaceButton(UINT uiCmd, const CMFCToolBarButton& button, BOOL bEvery = FALSE);
