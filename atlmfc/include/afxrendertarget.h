...
protected:
	/// <summary>
	/// Resource will be destroyed by owner (CRenderTarget)</summary>
...
public:
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pLayer != NULL; }
...
public:
	...
	/// If the method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
	/// <param name="pRenderTarget">A pointer to the render target.</param>
	HRESULT Create(CRenderTarget* pRenderTarget) override;
...
public:
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pBitmap != NULL; }
...
public:
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pBrush != NULL; }
...
public:
	...
	/// If the method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
	/// <param name="pRenderTarget">A pointer to the render target.</param>
	HRESULT ReCreate(CRenderTarget* pRenderTarget) override { UNREFERENCED_PARAMETER(pRenderTarget); return S_OK; }
	...
	/// If the method succeeds, it returns S_OK. Otherwise, it returns an HRESULT error code.</returns>
	/// <param name="pRenderTarget">A pointer to the render target.</param>
	HRESULT Create(CRenderTarget* pRenderTarget) override { UNREFERENCED_PARAMETER(pRenderTarget); return S_OK; }
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pTextFormat != NULL; }
...
public:
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pTextLayout != NULL; }
...
public:
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pGeometry != NULL; }
...
public:
	...
	/// <returns>
	/// TRUE if resource is valid; otherwise FALSE.</returns>
	BOOL IsValid() const override { return m_pMesh != NULL; }
...
EXTERN_PROCESS_LOCAL(_AFX_D2D_STATE, _afxD2DState)
