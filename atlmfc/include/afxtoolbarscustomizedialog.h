...
// Customization flags:
//---------------------
#define AFX_CUSTOMIZE_MENU_SHADOWS    0x0001 // Allow change menu shadow appearance
#define AFX_CUSTOMIZE_TEXT_LABELS     0x0002 // Allow change toolbar text labels below the image
#define AFX_CUSTOMIZE_MENU_ANIMATIONS 0x0004 // Allow change menu animations
