...
// _AFX_DEBUG_STATE is unused but maintained for binary compatibility reasons.
...
class _AFX_DEBUG_STATE2 : public CNoTrackObject
{
public:
	_AFX_DEBUG_STATE2();
	virtual ~_AFX_DEBUG_STATE2();
private:
	_CrtMemState mfcInitState;
};

EXTERN_PROCESS_LOCAL(_AFX_DEBUG_STATE2, afxDebugState)
...
inline int __cdecl  _AfxInitManaged()
{
    return 0;
}
#endif
