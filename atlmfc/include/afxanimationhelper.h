...
private:
    ...
    template <class IUIAnimationCallback_Inner, class CUIAnimationCallbackDerived_Inner>
    class CUIAnimationCallbackObject :
        public CUIAnimationCallbackDerived_Inner
    {
    public:
        ...
        {
            IUIAnimationCallback_Inner **ppAnimationInterface = reinterpret_cast<IUIAnimationCallback_Inner **>(ppvObject);
