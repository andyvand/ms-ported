...
class CSimpleList;
class CThreadSlotData;                  // for manipulating thread local storage
...
// Operations
	...
	void DeleteValues(HINSTANCE hInst, BOOL bEvery = FALSE);
...
void AFXAPI AfxTermLocalData(HINSTANCE hInstTerm, BOOL bEvery = FALSE);
