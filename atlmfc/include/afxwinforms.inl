...
#pragma warning(suppress : 4189) // ok is needed for assertion
		...
		if (posRemove)
		{
			...
			pThisSitePlaceHolderWnd->m_pSite = NULL; //So delete m_pSite in COleControlSiteOrWnd will not destroy the site.
