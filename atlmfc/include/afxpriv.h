...
#ifdef _DEBUG
// Special _CLIENT_BLOCK type to identify CObjects.
...
protected:
	...
	CSize ComputeDeltas(int& x, _In_z_ LPCTSTR lpszString, UINT& nCount, BOOL bTabbed,
					UINT nTabStops, _In_reads_(nTabStops) LPINT lpnTabStops, int nTabOrigin,
