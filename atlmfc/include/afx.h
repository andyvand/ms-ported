...
#if defined(_MANAGED) && !defined(_M_IX86) && !defined(_M_X64) && !defined(_M_ARM64) && !defined(__i386__) && !defined(__x86_64__) && !defined(__arm__) && !defined(__aarch64__)
...
#else
static void AFXAPI AfxThrowArchiveException(int cause, LPCTSTR lpszArchiveName);
#endif
...
#if 1
static void AFXAPI AfxThrowArchiveException(int cause, LPCTSTR lpszArchiveName = NULL)
{
