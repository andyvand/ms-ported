...
// Attributes
	...
	BOOL SetRange(_In_opt_ const COleDateTime* pMinRange, _In_opt_ const COleDateTime* pMaxRange);

	// Retrieves the current minimum and maximum allowable times for the datetime picker control.
	DWORD GetRange(_Inout_opt_ COleDateTime* pMinRange, _Inout_opt_ COleDateTime* pMaxRange) const;

	// Sets the minimum and maximum allowable times for the datetime picker control.
	BOOL SetRange(_In_opt_ const CTime* pMinRange, _In_opt_ const CTime* pMaxRange);

	// Retrieves the current minimum and maximum allowable times for the datetime picker control.
	DWORD GetRange(_Inout_opt_ CTime* pMinRange, _Inout_opt_ CTime* pMaxRange) const;
...
// Operations
	...
	BOOL SetRange(_In_opt_ const COleDateTime* pMinTime, _In_opt_ const COleDateTime* pMaxTime);
	...
	// Sets the minimum and maximum allowable dates for the calendar control.
	BOOL SetRange(_In_opt_ const CTime* pMinTime, _In_opt_ const CTime* pMaxTime);

	// Retrieves the minimum and maximum allowable dates set for the calendar control.
	DWORD GetRange(_Out_ CTime* pMinTime, _Out_ CTime* pMaxTime) const;

	// Sets the minimum and maximum allowable dates for the calendar control.
	BOOL SetRange(_In_opt_ const LPSYSTEMTIME pMinRange, _In_opt_ const LPSYSTEMTIME pMaxRange);
