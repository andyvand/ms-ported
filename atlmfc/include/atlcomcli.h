...
template <class T>
class [[msvc::nocastguard]] _NoAddRefReleaseOnCComPtr :
    public T
{
    private:
...
// AtlAdvise and AtlUnadvise are defined in <atlbase.h>.
ATLAPI AtlAdvise(
...
public:
    ...
    CComBSTR& operator=(nullptr_t) throw()
    {
        ::SysFreeString(m_str);
        m_str = NULL;
        return *this;
