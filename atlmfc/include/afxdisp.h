...
#define BEGIN_DISPATCH_MAP(theClass, baseClass) \
	_Ret_notnull_ const AFX_DISPMAP* PASCAL theClass::GetThisDispatchMap() \
...
#else
#define BEGIN_DISPATCH_MAP(theClass, baseClass) \
	_Ret_notnull_ const AFX_DISPMAP* theClass::GetDispatchMap() const \
		{ return &theClass::dispatchMap; } \
	AFX_COMDAT const AFX_DISPMAP theClass::dispatchMap = \
...
#pragma warning(pop)
	...
	_Success_(return == 0)
	friend SCODE AFXAPI AfxDllGetClassObject(_In_ REFCLSID, _In_ REFIID, _COM_Outptr_ LPVOID*);
...
protected:
	...
	CCmdTarget* OnCreateObject() override;
...
#define CONNECTION_IID(iid) \
		REFIID GetIID() override { return iid; }
...
_Success_(return == 0)
SCODE AFXAPI AfxDllGetClassObject(_In_ REFCLSID rclsid, _In_ REFIID riid, _COM_Outptr_ LPVOID* ppv);
...
public:
	...
	BOOL operator==(const COleVariant& varSrc) const
		{ return *this == static_cast<const VARIANT&>(varSrc); }
