...
#ifndef AFX_EXPORT
#if defined(_AFXDLL) && defined(_MFC_BLD)
#define AFX_EXPORT __declspec(dllexport)
#elif defined(_AFXDLL)
#define AFX_EXPORT __declspec(dllmport)
#else
#define AFX_EXPORT
#endif
#endif
...
#elif defined(_MFC_BLD) && defined(_AFXDLL)
    #define AFX_IMPORT_DATA __declspec(dllexport)
#else
...
#if defined(_AFXDLL)
#define AFX_CORE_DATA AFX_DATA
#define AFX_CORE_DATADEF AFX_DATADEF
#else
...
#ifndef AFX_OLE_DATA
#if defined(_AFXDLL)
#define AFX_OLE_DATA AFX_DATA
#define AFX_OLE_DATADEF AFX_DATADEF
#else
#define AFX_OLE_DATA
...
#ifndef AFX_DB_DATA
#if defined(_AFXDLL)
#define AFX_DB_DATA AFX_DATA
#define AFX_DB_DATADEF AFX_DATADEF
#else
#define AFX_DB_DATA
...
#ifndef AFX_NET_DATA
#if defined(_AFXDLL)
#define AFX_NET_DATA AFX_DATA
#define AFX_NET_DATADEF AFX_DATADEF
#else
#define AFX_NET_DATA
...
#ifndef AFX_EXT_DATA
#if defined(_AFXDLL)
#define AFX_EXT_DATA AFX_DATA
#define AFX_EXT_DATADEF AFX_DATADEF
#define AFX_EXT_CLASS AFX_DATA
#define AFX_EXT_API AFX_API
#else
#define AFX_EXT_DATA
#define AFX_EXT_DATADEF
#define AFX_EXT_CLASS
#define AFX_EXT_API __stdcall
#endif
#endif
