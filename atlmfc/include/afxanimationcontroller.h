...
protected:
	...
	void GetAnimationVariableList(CList<CAnimationVariable*, CAnimationVariable*>& lst) override;
};
...
public:
	...
	/// <param name="risingOrFalling">Whether the start of the transition is rising or falling.</param>
