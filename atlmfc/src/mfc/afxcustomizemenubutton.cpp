...
AFX_EXPORT CMFCToolBar* CMFCCustomizeMenuButton::m_pWndToolBar = NULL;

AFX_EXPORT BOOL CMFCCustomizeMenuButton::m_bRecentlyUsedOld = FALSE;
...
void CMFCCustomizeMenuButton::UpdateCustomizeButton()
{
	...
	if (m_pWndToolBar->GetParent()->m_hWnd != NULL)
	{
