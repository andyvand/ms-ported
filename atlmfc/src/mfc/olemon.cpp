		...
		*ppvObj = NULL;
		...
		if (pBC)
		{
			...
			if (pBSC)
			{
				...
				hr = RegisterBindStatusCallback(BindCtx, pBSC, &pBSCPrev, 0);
#else
#pragma warning (suppress: 6387) // C6387: '_Param_(3)' could be '0': this does not adhere to the specification for the function 'RegisterBindStatusCallback'.
