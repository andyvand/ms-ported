...
#else
void CTaskDialog::SetMainIcon(_In_ LPCSTR lpszMainIcon)
#endif
{
...
#else
void CTaskDialog::SetFooterIcon(_In_ LPCSTR lpszFooterIcon)
#endif
{
...
INT_PTR __stdcall CTaskDialog::ShowDialog(_In_ const CString& strContent, _In_ const CString& strMainInstruction, _In_ const CString& strTitle,
		_In_ int nIDCommandControlsFirst, _In_ int nIDCommandControlsLast,
