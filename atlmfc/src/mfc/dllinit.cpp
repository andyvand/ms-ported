...
#ifndef BuildNumberMajor
#define BuildNumberMajor 15
#endif
...
void AFXAPI AfxTermExtensionModule(AFX_EXTENSION_MODULE& state, BOOL bEvery)
{
	...
	for (CDynLinkLibrary* pDLL = pModuleState->m_libraryList; pDLL != NULL; )
	{
		...
		if (bEvery || pDLL->m_hModule == state.hModule)
...
#ifdef _AFX_OLE_IMPL
			AfxWinInit(hInstance, NULL, const_cast<LPTSTR>(_T("")), 0);
