...
void __stdcall CMFCVisualManager::RedrawAll()
{
	...
	for (POSITION pos = lstFrames.GetHeadPosition(); pos != NULL;)
	{
		...
		if (CWnd::FromHandlePermanent(pFrame->m_hWnd) != NULL)
		{
			...
			if (pFrame->m_hWnd == pMainWnd->m_hWnd)
			{
...
{
	m_hThemeWindow      = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"WINDOW");
	m_hThemeToolBar     = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"TOOLBAR");
	m_hThemeButton      = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"BUTTON");
	m_hThemeStatusBar   = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"STATUS");
	m_hThemeRebar       = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"REBAR");
	m_hThemeComboBox    = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"COMBOBOX");
	m_hThemeProgress    = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"PROGRESS");
	m_hThemeHeader      = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"HEADER");
	m_hThemeScrollBar   = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"SCROLLBAR");
	m_hThemeExplorerBar = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"EXPLORERBAR");
	m_hThemeTree        = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"TREEVIEW");
	m_hThemeStartPanel  = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"STARTPANEL");
	m_hThemeTaskBand    = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"TASKBAND");
	m_hThemeTaskBar     = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"TASKBAR");
	m_hThemeSpin        = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"SPIN");
	m_hThemeTab         = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"TAB");
	m_hThemeToolTip     = OpenThemeData(AfxGetMainWnd ()->m_hWnd, L"TOOLTIP");
	m_hThemeTrack       = OpenThemeData(AfxGetMainWnd()->m_hWnd, L"TRACKBAR");
