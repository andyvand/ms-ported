...
//
// Add a 32-bit floating point value by populating the lower 4 bytes
// of the 8 VFP register parameters. Returns TRUE if the data fit in
// registers, or FALSE if it must be added to the stack.
//
