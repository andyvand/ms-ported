...
BOOL _afxCriticalInit = 0;   // set _afxGlobalLock, _afxTempLock init

// _afxResourceLock and _afxLockInit are used to lock each MFC global resource
CRITICAL_SECTION _afxResourceLock[CRIT_MAX] = { { 0 } };
CRITICAL_SECTION _afxLockInitLock = { 0 };
BOOL _afxLockInit[CRIT_MAX] = { 0 };
#ifdef _DEBUG
BOOL _afxResourceLocked[CRIT_MAX] = { 0 };
#endif
...
void AFXAPI AfxLockGlobals(int nLockType)
{
	...
	// initialize global state, if necessary
	if (!_afxCriticalInit)
	{
		AfxCriticalInit();
