...
#ifdef _MSC_VER
extern PVOID WINAPI RtlAllocateHeap(PVOID, INT, size_t);
#endif
...
#endif
{
    ...
    CurDir.Buffer = RtlAllocateHeap((PVOID)RtlProcessHeap(), 0, CurDir.MaximumLength);
    ...
    DestDir.Buffer = RtlAllocateHeap((PVOID)RtlProcessHeap(), 0, DestDir.MaximumLength);
    ...
    Status = VerFindFileW(wFlags,
                        ...
                        WinDir.Buffer,
                        AppDir.Buffer,
                        CurDir.Buffer, (PUINT)&CurDirLen,
                        DestDir.Buffer, (PUINT)&DestDirLen);
...
#endif
{
    ...
    TmpFile.Buffer = RtlAllocateHeap((PVOID)RtlProcessHeap(), 0, TmpFile.MaximumLength);
    ...
    Status = VerInstallFileW(wFlags,
                        ...
                        DstDir.Buffer,
                        CurDir.Buffer,
                        TmpFile.Buffer, (PUINT)&TmpFileLen);
